...
int main(){
    ...
    double *altura[1000], *dadoEditadoDouble, *alturaValidacao[1000], alturaEmDouble[1000];
    bool *vacina[1000];
    ...
    case 1:         //INCLUIR USUARIO
        ...
        for (i=0; i < 1000; i++) {
           ...
           // alturaValidacao[i] = (double*) malloc(sizeof(double));
            ...
            //alturaEmDouble[i] = *alturaValidacao[i];
            // if (alturaEmDouble[i] > 1.0 && alturaEmDouble[i] < 2.0){
